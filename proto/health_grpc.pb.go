...
const (
	Health_HealthCheck_FullMethodName = "/FL.v1.Health/HealthCheck"
)
...
func (c *healthClient) HealthCheck(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
...
func (UnimplementedHealthServer) HealthCheck(context.Context, *HealthRequest) (*HealthResponse, error) {
